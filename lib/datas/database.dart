...
const List<Comic> coms = [
  ...
  Comic(
      ...
      imgPoster:
          'https://static.posters.cz/image/350/posters/spider-man-web-sling-i34546.jpg'),
  Comic(
      title: 'The Three Jokers',
      categories: 'Actions, Comedy, Romance',
      description:
          'The Three Jokers are trying to kill BATMAN, but BATMAN kills them All , with their parent, and dogs. ',
      imgPoster:
          'https://media.comicbook.com/2018/08/the-three-jokers-movie-version-1129715.jpeg'),
  Comic(
      title: 'The Three Jokers and me who run away',
      categories: 'Actions, Comedy, Romance',
      description:
          'The Three Jokers are trying to kill BATMAN, but BATMAN kills them All , with their parent, and dogs. ',
      imgPoster:
  ...
  Comic(
      ...
      categories: 'Actions, Comedy',
      description: 'The Story of peter being good neighbourhood hero',
      imgPoster:
